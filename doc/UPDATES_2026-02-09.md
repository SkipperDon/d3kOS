...
## Notes
- All source files maintained in `/home/boatiq/Helm-OS/`
- Deployment requires SSH key authentication
- Browser cache may need hard refresh (Ctrl+Shift+R) to see updates
- Boot splash changes require system reboot
