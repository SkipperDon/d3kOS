...
### DISTRIBUTION PREP DOMAINS (2026-02-18)

#### Domain Dist-1: Install Scripts
**Owns (create new):**
...
#### Domain Dist-2: Config & Services Scripts
**Owns (create new):**
- `/opt/d3kos/scripts/configure-autostart.sh`
- `/opt/d3kos/scripts/configure-network.sh`
- `/opt/d3kos/scripts/configure-touchscreen.sh`
- `/opt/d3kos/scripts/first-boot-setup.sh`
- `/opt/d3kos/scripts/backup.sh`
- `/opt/d3kos/scripts/restore.sh`
- `/opt/d3kos/scripts/sanitize.sh`
- `/etc/systemd/system/d3kos-first-boot.service`

#### Domain Dist-3: Testing Scripts
**Owns (create new):**
- `/opt/d3kos/tests/*.sh` (9 test scripts)

#### Domain Dist-4: Documentation
**Owns (create new):**
- `/home/boatiq/Helm-OS/doc/distribution/*.md` (10 docs)
- `/opt/d3kos/scripts/package-release.sh`
